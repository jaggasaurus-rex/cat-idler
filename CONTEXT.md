...
| `TOKEN_PACK_COST_OWN_LLM` | `float` | `10.0` | Token pack price once `research_your_own_llms` completes; currently a forward-declared const — `get_token_pack_cost()` in GameState does not yet reference it (effect implementation is a future task) |
